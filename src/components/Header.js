  ...
  return (
    <Stack >
        ...
        <Flex direction={isNotSmallScreen ? "row":"column"}
            p={isNotSmallScreen ? "32" : "10"}
            alignSelf="center">
            
            <Box
             mt={isNotSmallScreen ? "0":"200px"} align ="flex-start" textAlign={{base:"center", md:"left", lg:"left"}}  alignItems={{base:"center", md:"center", lg:"flex-start"}} w="100">
                ...
                <Link href='https://docs.google.com/document/d/1BUg2-Sk7_aeZkihm55ljjSnreDt62nTK0zj515EzoEU/edit?usp=sharing'>
                    <Button mt={8} colorScheme="blue" ml={{base:"0", md:"50px", lg:"0"}} w="inherit">View my Resume</Button>
                </Link>
            </Box>
            <Box>
