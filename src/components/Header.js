  ...
  return (
    <Stack >
        ...
        <Flex direction={isNotSmallScreen ? "row":"column"}
            p={isNotSmallScreen ? "32" : "5"}
            alignSelf="center">
            
            <Box
             mt={isNotSmallScreen ? "0":"250px"} align ="flex-start" textAlign={{base:"center", md:"left", lg:"left"}}  alignItems={{base:"center", md:"center", lg:"flex-start"}} w="100">
